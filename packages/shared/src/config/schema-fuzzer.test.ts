  ...
  auth: [{
    ...
    oauth: [{
      ...
      providers: [typedFromEntries(typedEntries(branchSchemaFuzzerConfig[0].auth[0].oauth[0].providers[0]).map(([key, value]) => [key, [{
        ...
        displayName: [undefined, "My SSO Provider"] as (string | undefined)[],
        iconUrl: [undefined, "https://example.com/icon.png"] as (string | undefined)[],
        authorizationEndpoint: [undefined, "https://idp.example.com/authorize"] as (string | undefined)[],
        tokenEndpoint: [undefined, "https://idp.example.com/token"] as (string | undefined)[],
        userinfoEndpoint: [undefined, "https://idp.example.com/userinfo"] as (string | undefined)[],
      }]]))] as const,
    }],
  }],
  domains: [{
