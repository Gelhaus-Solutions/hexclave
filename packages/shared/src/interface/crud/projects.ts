...
export const projectsCrudAdminReadSchema = yupObject({
  ...
  config: yupObject({
    ...
    mtls_enabled: schemaFields.projectMtlsEnabledSchema.defined(),
    anonymous_sign_in_enabled: schemaFields.projectAnonymousSignInEnabledSchema.defined(),
    // TODO: remove this
...
export const projectsCrudAdminUpdateSchema = yupObject({
  ...
  config: yupObject({
    ...
    mtls_enabled: schemaFields.projectMtlsEnabledSchema.optional(),
    anonymous_sign_in_enabled: schemaFields.projectAnonymousSignInEnabledSchema.optional(),
